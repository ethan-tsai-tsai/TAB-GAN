...
def parse_args():
    ...
    parser.add_argument('--num_layers_d', type=int, default=2, help='discriminator hidden layer number')
    ...
    parser.add_argument('--d_iter', type=int, default=2, help='iteration of training discriminator before training generator')
    parser.add_argument('--gp_lambda', type=float, default=10, help='lambda of gradient penalty')
    
    # Evaluation
    parser.add_argument('--pred_times', type=int, default=2, help='prediction time in one time point')
    parser.add_argument('--bound_percent', type=float, default=100, help='confidence of bound')
