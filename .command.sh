# main
nohup python -u main.py --stock 1476 --cuda 3 > ./out/1476.out 2>&1 &
nohup python -u main.py --stock 2330 --cuda 4 > ./out/2330.out 2>&1 &
nohup python -u main.py --stock 2731 --cuda 5 > ./out/2731.out 2>&1 &
nohup python -u main.py --stock 3008 --cuda 6 > ./out/3008.out 2>&1 &
nohup python -u main.py --stock 3167 --cuda 7 > ./out/3167.out 2>&1 &
